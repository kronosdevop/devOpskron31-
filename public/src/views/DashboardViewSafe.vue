      ...
      <v-card-text class="pa-0">
        ...
        <v-row class="dashboard-grid">
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-pinkorange">
                    <v-icon class="icon-outline" size="20">mdi-file-clock-outline</v-icon>
                  </div>
                </div>
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-yellow">
                    <v-icon class="icon-outline" size="20">mdi-file-check-outline</v-icon>
                  </div>
                </div>
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-blue">
                    <v-icon class="icon-outline" size="20">mdi-file-document-multiple-outline</v-icon>
                  </div>
                </div>
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-green">
                    <v-icon class="icon-outline" size="20">mdi-plus-box-outline</v-icon>
                  </div>
                </div>
          ...
          <v-col cols="12" sm="6" md="4" class="dashboard-col">
            ...
            >
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-blue">
                    <v-icon class="icon-outline" size="20">mdi-clipboard-text-outline</v-icon>
                  </div>
                </div>
                ...
                <!-- Description -->
                <p class="card-description">Your assigned tasks and activities</p>
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-purple">
                    <v-icon class="icon-outline" size="20">mdi-broadcast</v-icon>
                  </div>
                </div>
                ...
                <div v-if="recentChannels.length > 0" class="recent-info">
                  <div class="recent-channel">
                    <span class="channel-icon" :class="recentChannels[0].team_type === 'NOTIFICATION_CHAT' ? 'bg-green' : 'bg-pink'">
                      <v-icon color="white" size="14">
                        {{ recentChannels[0].team_type === "NOTIFICATION_CHAT" ? "mdi-bell" : "mdi-chat" }}
                      </v-icon>
                    </span>
                    <span class="channel-name">{{ recentChannels[0].team_name }}</span>
                  </div>
                </div>

                <!-- Description -->
                <p class="card-description">Communication channels and notifications</p>
              </v-card-text>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" md="6" class="dashboard-col">
            <v-card 
              class="dashboard-card dashboard-card-large"
              elevation="2"
            >
              <v-card-text class="pa-3">
                <!-- Header with Icon -->
              ...
              <v-card-text class="pa-3">
                ...
                <div class="d-flex align-start mb-2">
                  <div class="icon-container icon-bg-pink">
                    <v-icon class="icon-outline" size="20">mdi-chat-outline</v-icon>
                  </div>
                </div>
                ...
                <div class="chat-list">
                  <div
                    v-for="chat in chatListWithNames.slice(0, 4)"
                    :key="chat.team_id"
                    class="chat-item"
                  >
                    <span class="chat-avatar bg-pink">
