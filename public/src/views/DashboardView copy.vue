  ...
  <div>
    ...
    <v-card flat class="dashboard-root">
      <v-card-text class="">
        ...
        <v-card class="welcome-banner mb-8 mt-6" elevation="0">
          <div class="welcome-inner">
            ...
            <div class="banner-left">
              ...
              <div>
                <h2 class="welcome-title mt-5 ml-3">Welcome to Stichh</h2>
                <p class="welcome-subtitle mb-n1 ml-3">
            ...
            <div class="banner-right">
              <v-img :src="AppDownload" class="banner-logo " width="200" contain />
              <div class="store-buttons mb-1 mr-3">
                <span class="store-btn">
                  <v-icon size="18">mdi-google-play</v-icon>
                  Play Store
                </span>
                <span class="store-btn">
                  <v-icon size="18" class="mb-1">mdi-apple</v-icon>
                  App Store
                </span>
              </div>
            </div>
        ...
        <h3 class="section-title mt-3 ml-2">
        ...
        <v-card class="quick-actions-card mt-5" elevation="0">
          <div class="quick-actions-grid">
            <div v-for="action in quickActionsList" :key="action.actionType" class="quick-action-item soft-hover"
