...
export default {
  ...
  data() {
    return {
      ...
      currentNavList: [
        ...
        {
          icon: require("@/assets/networking.png"),
          text: "My Team",
          abbreviation: "TEAM",
          // router: "/home/UserTeams",
          router: "/home/AdminTeam",
          isActive: false,
          isImage: true,
        },
      ],
  ...
  methods: {
    ...
    fetch_user_level_apps(value) {
      ...
      value.forEach((element) => {
        this.userAppsList.push({
          ...
          isImage: this.isImageIcon(element.dashboard_unique_type),
        });
      });
      if (this.userAppsList.length != 0) {
        ...
        if (exist == undefined) {
          ...
          if (adminAppExists) {
            this.userAppsList.push({
              ...
              isImage: this.isImageIcon(adminExists.dashboard_unique_type),
            });
          }
        }
        ...
        const exist7 = this.userAppsList.find(
          (item) => item.dashboard_unique_type == "REWARDS_RECOGNITION_USERS"
        );
        ...
        const exist8 = this.userAppsList.find(
          (item) => item.dashboard_unique_type == "TICKET_MANAGEMENT"
        );
        ...
        if (exist8 == undefined) {
          ...
          const adminExists = userObj.admin_apps.find(
            (app) => app.dashboard_unique_type === "TICKET_MANAGEMENT_ADMINS"
          );
    ...
    fetch_admin_apps(value) {
      ...
      this.adminAppsList = this.adminAppsList.filter(
        (item) => item.dashboard_unique_type != "REWARDS_MANAGEMENT_ADMINS"
      );
      this.adminAppsList = this.adminAppsList.filter(
        (item) => item.dashboard_unique_type != "TICKET_MANAGEMENT_ADMINS"
      );
      this.adminAppsList = this.adminAppsList.filter(
    ...
    fecth_icons(element) {
      ...
      switch (element.dashboard_unique_type) {
        ...
        case "PREZENCE":
          return require("@/assets/reminder.png");

        case "TICKET_MANAGEMENT":
          return require("@/assets/tickets.png");

        case "EXPENSE":
          return require("@/assets/expenses.png");

        case "BOOKING_SLOT":
          return require("@/assets/bookingonline.png");

        case "DIRECTORY_USER":
          return require("@/assets/directory_listing.png");

        case "TIMESHEET_USER":
          return require("@/assets/schedule.png");

        case "PAYROLL":
          return "mdi-cash";

        case "ASSETS_USER":
          return require("@/assets/assets.png");
        ...
        case "FORMS_ADMINS":
          return require("@/assets/registration_form.png");
        ...
        case "SPLAY_ADMINS":
          return require("@/assets/splay.png");
        ...
        case "user_approvals_ADMINS":
          return require("@/assets/workflow.png");
        ...
        case "QABM_ADMINS":
          return require("@/assets/sales.png");
        case "QABM_USERS":
          return require("@/assets/sales.png");
        case "LOADOPT_ADMIN":
          return "mdi-truck-outline";
