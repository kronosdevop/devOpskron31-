<template>
        ...
        <v-card class="order-preview-card">
          <v-toolbar elevation="0" dark dense class="navBar">
            <v-toolbar-title class="text--black ml-2">
              <div class="custom-title">Purchase Invoice Preview</div>
            </v-toolbar-title>
            <v-spacer />
            ...
            <div v-if="!hasInvoiceData" class="loading-state">
              <div class="text-center py-8">
                <v-progress-circular
                  ...
                  class="mb-4"
                ></v-progress-circular>
                <div class="text-body-2 text-grey">Loading purchase invoice...</div>
              </div>
            </div>
            ...
            <div v-else class="order-content" ref="orderContent">
              ...
              <div class="order-header">
                ...
                <div class="header-right">
                  <h1 class="order-title">PURCHASE INVOICE</h1>
              ...
              <div class="supplier-section">
                <div class="supplier-info">
                  <div class="supplier-header">
                    <span class="section-title">Invoice From:</span>
                    <h3 class="supplier-name">
                      {{ selectedInvoice.supplier_name || selectedInvoice.party_name || "N/A" }}
                    </h3>
                  </div>
                  <div class="supplier-details-compact">
                    <span class="supplier-detail" v-if="selectedInvoice.supplier_address || selectedInvoice.address_line_1">
                      {{ selectedInvoice.supplier_address || selectedInvoice.address_line_1 }}
                    </span>
                    <span class="supplier-detail"
                      >GST: {{ selectedInvoice.supplier_gst || "N/A" }}</span
                    >
                    <span class="supplier-detail"
                      >Code: {{ selectedInvoice.supplier_code || "N/A" }}</span
                    >
                    <span class="supplier-detail"
                      >State: {{ selectedInvoice.supplier_state || "N/A" }}</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="order-summary-section">
                <div class="summary-container">
                  ...
                  <div class="summary-row" v-if="selectedInvoice.discount_percent && parseFloat(selectedInvoice.discount_percent) > 0">
                    <span class="summary-label">Discount ({{ selectedInvoice.discount_percent }}%):</span>
                    <span class="summary-value">-{{ formatAmount(selectedInvoice.discount_amount || '0.00') }}</span>
                  </div>
                  <div class="summary-row" v-if="selectedInvoice.tax_type && selectedInvoice.tax_type !== 'Exempt'">
                    <span class="summary-label">Tax ({{ selectedInvoice.tax_type }}):</span>
                    <span class="summary-value">{{ formatAmount(selectedInvoice.tax_amount || '0.00') }}</span>
                  </div>
                  <div class="summary-row" v-if="selectedInvoice.round_off && parseFloat(selectedInvoice.round_off_amount || '0') !== 0">
                    <span class="summary-label">Round Off:</span>
                    <span class="summary-value">{{ formatAmount(selectedInvoice.round_off_amount || '0.00') }}</span>
                  </div>
  ...
  export default {
    name: "PurchaseInvoicePreviewDialog",
    ...
    methods: {
      ...
      printInvoice() {
        ...
        printWindow.document.write(`
          <html>
            <head>
              <title>Purchase Invoice - ${this.selectedInvoice.invoice_no || 'N/A'}</title>
              <style>
                * {
