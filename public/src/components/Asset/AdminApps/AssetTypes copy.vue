  ...
  <div>
    <v-app-bar class="modern-header-section">
      ...
      <div class="header-actions">
        <!-- Search Field -->
        <div v-if="toggle_exclusive == 'adminasset'" class="search-container">
          <v-text-field
            v-model="searchValue"
        ...
        <v-menu offset-y v-if="toggle_exclusive == 'adminasset'" class="actions-menu">
...
import { asset_categories, asset_sub_category, assets } from "@/graphql/mutations.js";
...
export default {
  ...
  methods: {
    ...
    handleSearchChange() {
      // This method will be called when the search value changes
      // console.log('Search value changed:', this.searchValue);
      // Trigger refresh of asset list to apply search
      if (this.$refs.allAssetList) {
        this.$refs.allAssetList.updatePageItems();
      }
    },
