        ...
        <div class="d-flex align-center justify-space-between">
          <div class="page-title">
            <div class="d-flex align-center">
              ...
              <span class="font-weight-bold text-h6">Delivery Failed Assets</span>
            </div>
          </div>
          <v-btn
            variant="text"
        ...
        >
          <template v-slot:no-data>
            <div class="text-center py-8">
              ...
              <div class="text-h6 text-grey mb-2">No Delivery Failed Assets Found</div>
              <div class="text-body-2 text-grey">
                No assets have failed delivery.
              </div>
            </div>
          </template>
          ...
          <template v-slot:loading>
            <div class="text-center py-8">
              <v-progress-circular
                ...
                class="mb-4"
              ></v-progress-circular>
              <div class="text-body-2 text-grey">Loading delivery failed assets...</div>
            </div>
          </template>
          ...
          <template v-slot:[`item.location_id_text`]="{ item }">
            <span>{{
              item.location_id_text == null || item.location_id_text == undefined || item.location_id_text == ""
                ? "-"
                : item.location_id_text
            }}</span>
          </template>
        ...
        <div class="table-footer">
          <div class="footer-info">
            {{
              totalCount === 0
                ? "No Results"
                : `Showing ${paginatedItems.length} of ${totalCount} delivery failed assets`
            }}
          </div>
...
export default {
  ...
  data() {
    return {
      headers: [
        { title: "Asset ", key: "asset_prefix", sortable: false },
        ...
        { title: "Location", key: "location_id_text", sortable: false },
  ...
  methods: {
    ...
    updateWindowHeight() {
      this.windowHeight = window.innerHeight - 320; // Adjust height as needed
    },
