        ...
        <div class="d-flex align-center justify-space-between">
          <div class="page-title">
            <div class="d-flex align-center">
              ...
              <span class="font-weight-bold text-h6">Delivered Assets</span>
            </div>
          </div>
          <v-btn
            variant="text"
        ...
        >
          <template v-slot:no-data>
            <div class="text-center py-8">
              ...
              <div class="text-h6 text-grey mb-2">No Acknowledged Assets Found</div>
              <div class="text-body-2 text-grey">
                No assets have been acknowledged yet.
              </div>
            </div>
          </template>
          ...
          <template v-slot:loading>
            <div class="text-center py-8">
              <v-progress-circular
                ...
                class="mb-4"
              ></v-progress-circular>
              <div class="text-body-2 text-grey">Loading acknowledged assets...</div>
            </div>
          </template>
        ...
        <div class="table-footer">
          <div class="footer-info">
            {{
              totalCount === 0
                ? "No Results"
                : `Showing ${paginatedItems.length} of ${totalCount} acknowledged assets`
            }}
          </div>
