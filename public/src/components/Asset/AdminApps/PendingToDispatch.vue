        ...
        <div class="d-flex align-center justify-space-between">
          <div class="page-title">
            <div class="d-flex align-center">
              ...
              <span class="font-weight-bold text-h6">Pending to Dispatch</span>
            </div>
          </div>
          <v-btn
            variant="text"
        ...
        >
          <template v-slot:no-data>
            <div class="text-center py-8">
              ...
              <div class="text-h6 text-grey mb-2">No Pending Assets Found</div>
              <div class="text-body-2 text-grey">
                No assets are currently pending for dispatch.
              </div>
            </div>
          </template>
          ...
          <template v-slot:loading>
            <div class="text-center py-8">
              <v-progress-circular
                ...
                class="mb-4"
              ></v-progress-circular>
              <div class="text-body-2 text-grey">Loading pending assets...</div>
            </div>
          </template>
        ...
        <div class="table-footer">
          <div class="footer-info">
            {{
              totalCount === 0
                ? "No Results"
                : `Showing ${paginatedItems.length} of ${totalCount} pending assets`
            }}
          </div>
      ...
      try {
        ...
        if (response.Status == "SUCCESS") {
          ...
          response.data.forEach((element) => {
            // Debug: Log the structure of each element
            // console.log('Element structure:', element);
            // console.log('workflow_payload:', element.workflow_payload);
            // console.log('asset_description from workflow_payload:', element.workflow_payload?.asset_description);
