<template>
  <div>
    ...
    <v-dialog
      ...
      @update:model-value="supplierAddition = $event"
      persistent
      max-width="500"
      ...
      <v-card>
        <v-toolbar elevation="0" dark density="compact" class="navBar">
          <v-toolbar-title class="text-white ml-2">
            <div class="custom-title text-white">Add Supplier/Vendor</div></v-toolbar-title
          >
          <v-spacer />
        ...
        let result = await API.graphql(
          graphqlOperation(aseet_suppliers, {
            input: {
              ...
              suppliers_email_id: this.supplieremailID,
