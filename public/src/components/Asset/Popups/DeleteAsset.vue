<template>
  <div>
    <!-- eslint-disable -->
    <v-dialog
      :model-value="assetdeletion"
      @update:model-value="assetdeletion = $event"
      persistent
      max-width="400"
      ...
      <v-card>
        <v-toolbar elevation="0" dark density="compact" class="bg-white">
          <!-- <v-toolbar-title class="ml-2">
            <div class="custom-title">Delete Asset</div></v-toolbar-title
          > -->
          <v-spacer />
        ...
        <v-card-text class="mt-6">
          <div class="text-center">
            Are you sure you want to delete asset of
