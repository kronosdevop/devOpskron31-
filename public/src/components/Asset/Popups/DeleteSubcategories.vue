<template>
  <div>
    <!-- eslint-disable -->
    <v-dialog
      :model-value="categoriessubdeletion"
      @update:model-value="categoriessubdeletion = $event"
      persistent
      ...
      <v-card>
        ...
        <v-card-text class="mt-6">
          <div class="text-center">
            ...
            <b> {{ categoriesItem.sub_category_name }} </b> ?
          </div>
        </v-card-text>
        ...
        let result = await API.graphql(
          graphqlOperation(asset_sub_category, {
            input: {
              ...
              sub_category_id: this.categoriesItem.sub_category_id,
            },
          })
        );
