...
import { Team_awards_workflow_configure } from "@/graphql/mutations.js";
  ...
  props: {
    ...
    workflowType: {
      ...
      validator: function (value) {
        return (
          ["expense", "petty_cash_request", "team_approval"].indexOf(value) !==
          -1
        );
      },
    },
    ...
    async save_workflow_configuration(value) {
      ...
      try {
        ...
        result = await API.graphql(
          graphqlOperation(Team_awards_workflow_configure, {
            input: {
        ...
        var response = JSON.parse(result.data.Team_awards_workflow_configure);
        this.loading = false;
