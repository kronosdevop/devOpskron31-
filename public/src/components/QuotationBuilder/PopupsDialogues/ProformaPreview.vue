...
import { genrate_proforma_invoice } from "@/graphql/mutations.js";
    ...
    async Confirm_billing() {
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(genrate_proforma_invoice, {
            input: {
        ...
        this.loading = false;
        var response = JSON.parse(result.data.genrate_proforma_invoice);
        this.loading = false;
