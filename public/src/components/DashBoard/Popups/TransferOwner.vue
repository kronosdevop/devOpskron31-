<template>
  ...
  <script>
/* eslint-disable */
import { transfer_ownership_dashboard } from "@/graphql/mutations.js";
    ...
    async transfer_ownership() {
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(transfer_ownership_dashboard, {
            input: {
        ...
        this.loading = false;
        var response = JSON.parse(result.data.transfer_ownership_dashboard);
