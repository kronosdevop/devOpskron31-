      ...
      <v-card flat class="ma-2" >
        ...
        >
          <v-col cols="auto" class="d-flex align-center">
            ...
            <span class="font-weight-bold text-h6">My Dashboards ({{ totalCount }})</span>
          </v-col>
          <v-spacer /> -->
...
import { list_My_dashboards } from "@/graphql/queries.js";
    ...
    async fetch_dashboard_details() {
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(list_My_dashboards, {
            input: {
              limit: 50,
        ...
        var response = JSON.parse(result.data.list_My_dashboards);
