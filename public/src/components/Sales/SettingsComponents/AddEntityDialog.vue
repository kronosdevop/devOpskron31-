<template>
  <v-dialog v-model="dialog" max-width="800px" persistent>
    <v-card>
      <v-card-title
        class="text-h6 pa-4 d-flex align-center justify-space-between"
      >
              ...
              <v-col cols="12" md="4">
                <div class="logo-upload-container">
                  <v-file-input
                    ...
                    :rules="[(v) => !!v || 'Entity Logo is required']"
                    required
                  ></v-file-input>
                  <v-img
          ...
          <div class="mb-4">
            ...
            <div class="d-flex align-center justify-space-between">
              ...
              <v-switch
                ...
                inset
                :label="
                  showBusinessDetails ? 'Enabled' : 'Enable Business Details'
                "
              ></v-switch>
            </div>
          </div>
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                ...
                <v-text-field
                  ...
                  density="compact"
                  :rules="[
                    (v) => !v || v.length <= 160 || 'Maximum 160 characters',
                  ]"
                  counter="160"
                  class="mb-3"
                />
      ...
      <v-card-actions class="pa-4">
        ...
        <v-btn color="#DB4C77" @click="validateAndUpload" :loading="saving">
          Add Entity
        </v-btn>
      </v-card-actions>
    </v-card>
...
export default {
  ...
  methods: {
    ...
    async validateAndUpload() {
      ...
      // Additional validation for logo and signature
      if (!this.entityForm.logoFile) {
        this.$emit("errorMsg", "Please upload an Entity Logo.");
        return;
      }
      ...
      if (valid) {
        ...
        this.$emit(
          "errorMsg",
          "Please fill in all required fields (Entity Name and Logo are mandatory)."
        );
      }
    },
    ...
    async saveEntityData() {
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(quotation_billing_entities, {
            input: {
              ...
              entity_seal_signature: imageDetails.signature,
        ...
        console.log(error);
        this.saving = false;
        this.$emit("errorMsg", error.errors[0].message || "Error creating entity. Please try again.");
      }
    },
  },
};
