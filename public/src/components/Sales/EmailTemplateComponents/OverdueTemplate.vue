    ...
    <v-card flat class="pa-3 overflow-y-auto" :height="windowHeight">
      ...
      <v-card-title class="d-flex align-center justify-space-between pa-2">
        <div class="d-flex align-center">
          <v-icon class="mr-2" color="#DB4C77" size="20">mdi-clock-alert-outline</v-icon>
          <span class="text-h6">Overdue Payment Email Template</span>
        </div>
        <div class="d-flex align-center">
          <v-btn
            color="#DB4C77"
            ...
            <v-card class="pa-3" elevation="1">
              ...
              <v-card class="preview-card pa-3" elevation="0" style="border: 1px solid #e0e0e0">
                <div class="preview-header mb-2">
                  <strong>From:</strong> Your Company &lt;noreply@company.com&gt;
                </div>
                <div class="preview-header mb-2">
                  <strong>Subject:</strong> {{ emailSubject || 'Payment Overdue - {invoice_number}' }}
                </div>
                <div class="preview-header mb-2">
