    ...
    <v-card flat class="pa-3">
      ...
      <v-card-title class="d-flex align-center justify-space-between pa-2">
        <div class="d-flex align-center">
          <v-icon class="mr-2" color="#DB4C77" size="20">mdi-clipboard-text-outline</v-icon>
          <span class="text-h6">Sale Order Email Template</span>
        </div>
        <div class="d-flex align-center">
          <v-btn
            color="#DB4C77"
          ...
          <v-col cols="12" md="8">
            <v-card class="pa-3" elevation="1">
              ...
              <v-card class="preview-card pa-3" elevation="0" style="border: 1px solid #e0e0e0">
                ...
                <div class="preview-header mb-2">
                  <strong>Subject:</strong> {{ emailSubject || 'Sale Order Confirmation - {sale_order_number}' }}
                </div>
                <div class="preview-header mb-2">
...
export default {
  ...
  data() {
    return {
      ...
      // Template data
      templateName: "Sale Order Template",
      emailSubject: "Sale Order Confirmation - {{sale_order_number}}",
      senderName: "Sales Team",
      senderEmail: "sales@company.com",
      emailContent: "Dear {{customer_name}},\n\nThank you for your order! We are pleased to confirm your sale order has been received and is being processed.\n\n**Order Details:**\n- Sale Order Number: {{sale_order_number}}\n- Order Date: {{order_date}}\n- Expected Delivery: {{expected_delivery}}\n- Total Amount: {{total_amount}}\n\n**Order Status:**\nYour order is currently being processed and will be shipped according to the delivery schedule.\n\n**Next Steps:**\n1. We will send you tracking information once shipped\n2. You will receive delivery confirmation\n3. Invoice will be sent upon delivery\n\nIf you have any questions about your order, please contact our customer service team.\n\nThank you for choosing us!\n\nBest regards,\n{{sender_name}}\n{{company_name}}",

      // Available variables for template
      availableVariables: [
        { key: "{{customer_name}}", label: "Customer Name" },
        { key: "{{sale_order_number}}", label: "Sale Order Number" },
  ...
  methods: {
    ...
    async saveTemplate() {
      ...
      try {
        ...
        // console.log("Saving sale order template:", {
