<template>
        ...
        <v-card class="quotation-preview-card">
          <v-toolbar elevation="0" dark dense class="navBar">
            <v-toolbar-title class="text--black ml-2">
              <div class="custom-title">Proforma Preview</div>
            </v-toolbar-title>
            <v-spacer />
          ...
          <v-card-text class="pa-0">
            <!-- Loading State -->
            <div v-if="!hasProformaData" class="loading-state">
              ...
              <div v-else class="quotation-content" ref="quotationContent">
                ...
                <table class="quotation-header-table" border="1" cellspacing="0" cellpadding="8">
                  <tbody>
                    <tr>
                      <td class="header-left-cell" rowspan="3">
                      ...
                      <td class="header-right-cell quotation-title-cell">
                        <h1 class="quotation-title">PROFORMA</h1>
                      </td>
                    </tr>
                    <tr>
                      <td class="header-right-cell detail-row-cell">
                        <div class="detail-row-content">
                          <span class="detail-label">PROFORMA NO</span>
                          <span class="detail-value">{{
                            selectedProforma.invoice_no || "N/A"
                          }}</span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td class="header-right-cell detail-row-cell">
                        <div class="detail-row-content">
                          ...
                          <span class="detail-value">{{
                            formatDate(selectedProforma.invoice_date)
                          }}</span>
                        </div>
                      </td>
                    </tr>
                      ...
                      <td class="customer-info-cell">
                        <div class="customer-info">
                          <h3 class="customer-name">
                            {{ selectedProforma.customer_name || "N/A" }}
                          </h3>
                          <div class="customer-details-list">
                            <div class="customer-detail-row" v-if="selectedCustomer?.customer_display_id || selectedProforma.customer_code">
                              <span class="customer-detail-label">Customer ID#:</span>
                              <span class="customer-detail-value">{{ selectedCustomer?.customer_display_id || selectedProforma.customer_code }}</span>
                            </div>
                            <div class="customer-detail-row" v-if="selectedCustomer?.address_line_1 || selectedProforma.customer_address || selectedProforma.address_line_1">
                              <span class="customer-detail-label">Address:</span>
                              <span class="customer-detail-value">{{ selectedCustomer?.address_line_1 || selectedProforma.customer_address || selectedProforma.address_line_1 }}</span>
                            </div>
                            <div class="customer-detail-row" v-if="selectedCustomer?.primary_contact_no || selectedProforma.customer_phone">
                              <span class="customer-detail-label">Phone:</span>
                              <span class="customer-detail-value">{{ formatPhoneNumber(selectedCustomer?.primary_contact_no || selectedProforma.customer_phone) }}</span>
                            </div>
                            <div class="customer-detail-row" v-if="selectedCustomer?.gst_no || selectedProforma.customer_gst">
                              <span class="customer-detail-label">GST:</span>
                              <span class="customer-detail-value">{{ selectedCustomer?.gst_no || selectedProforma.customer_gst }}</span>
                            </div>
                            <div class="customer-detail-row" v-if="selectedCustomer?.state_1 || selectedProforma.customer_state">
                              <span class="customer-detail-label">State:</span>
                              <span class="customer-detail-value">{{ selectedCustomer?.state_1 || selectedProforma.customer_state }}</span>
                            </div>
                            <div class="customer-detail-row" v-if="selectedProforma.project_name">
                              <span class="customer-detail-label">Project:</span>
                              <span class="customer-detail-value">{{ selectedProforma.project_name }}</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      <td class="reference-info-cell">
                        <div class="reference-section">
                          <div class="reference-content">
                            <div v-if="selectedProforma.reference">{{ selectedProforma.reference }}</div>
                            <div v-if="selectedProforma.comments">{{ selectedProforma.comments }}</div>
                            <div v-if="selectedProforma.instructions">{{ selectedProforma.instructions }}</div>
                            <div v-if="!selectedProforma.reference && !selectedProforma.comments && !selectedProforma.instructions" class="empty-reference">
                              &nbsp;
                            </div>
                          </div>
                        </div>
              ...
              <table class="items-table-combined" border="1" cellspacing="0" cellpadding="8">
                ...
                <tbody>
                  <template v-if="proformaItems && proformaItems.length > 0">
                  ...
                  <template v-else>
                    <tr>
                      <td :colspan="itemConfiguration.items_wise_discount ? 9 : 8" class="text-center">No items available</td>
                    </tr>
                  </template>
                  ...
                  <tr>
                    <td :colspan="itemConfiguration.items_wise_discount ? 7 : 6" :rowspan="summaryRowspan" valign="top" class="notes-cell">
                      <div class="notes-section">
                        <strong v-if="selectedProforma.description">Note:</strong>
                        <div class="notes-content">
                          <div v-if="selectedProforma.description">
                            <template v-for="(line, idx) in formatNotes(selectedProforma.description)" :key="idx">
                              {{ idx + 1 }}. {{ line }}<br v-if="idx < formatNotes(selectedProforma.description).length - 1">
                            </template>
                          </div>
                  ...
                  <tr v-if="itemConfiguration.items_wise_discount && selectedProforma.discount_percent && parseFloat(selectedProforma.discount_percent) > 0">
                    <td align="left" class="summary-label-cell">Discount</td>
                    <td align="right" class="summary-value-cell">-{{ getCurrencySymbol() }}{{ formatAmount(selectedProforma.discount_amount || '0.00') }}</td>
                  </tr>

                  <tr v-if="selectedProforma.tax_type && selectedProforma.tax_type !== 'Exempt'">
                    <td align="left" class="summary-label-cell">Tax</td>
                    <td align="right" class="summary-value-cell">{{ getCurrencySymbol() }}{{ formatAmount(selectedProforma.tax_amount || '0.00') }}</td>
                  </tr>

                  <tr v-if="selectedProforma.round_off && parseFloat(selectedProforma.round_off_amount || '0') !== 0">
                    <td align="left" class="summary-label-cell">Round Off</td>
                    <td align="right" class="summary-value-cell">{{ getCurrencySymbol() }}{{ formatAmount(selectedProforma.round_off_amount || '0.00') }}</td>
                  </tr>
              ...
              <div v-if="selectedProforma.terms_conditions" class="terms-section">
                <div class="section-title">Terms and Conditions</div>
                <div class="terms-content">
                  {{ selectedProforma.terms_conditions }}
                </div>
              </div>
  ...
  export default {
    ...
    computed: {
      ...
      hasProformaData() {
        return (
          this.selectedProforma && Object.keys(this.selectedProforma).length > 0
        );
      },
      isDataReady() {
        // Check if proforma data exists and categories API call is complete
        return this.hasProformaData && !this.isLoadingCategories;
      },
      selectedProforma() {
        return this.proformaData || {};
      },
      selectedEntity() {
      ...
      selectedCustomer() {
        ...
        if (!this.selectedProforma?.customer_name || !this.masterCustomers || this.masterCustomers.length === 0) {
          return null;
        }
        return this.masterCustomers.find(
          (customer) => customer.legal_name === this.selectedProforma.customer_name
        ) || null;
      },
            proformaItems() {
        // Parse items from proforma data - handle multiple possible field names
        let items = [];

        // Try table_data first (this is the correct field name from EditProformaDialog)
        if (this.selectedProforma.table_data) {
          if (typeof this.selectedProforma.table_data === "string") {
            try {
              items = JSON.parse(this.selectedProforma.table_data);
            } catch (e) {
              console.error("Error parsing table_data:", e);
            }
          } else if (Array.isArray(this.selectedProforma.table_data)) {
            items = this.selectedProforma.table_data;
          }
        }

        // If no items found, try tableData field (fallback)
        if (!items || items.length === 0) {
          if (this.selectedProforma.tableData) {
            if (typeof this.selectedProforma.tableData === "string") {
              try {
                items = JSON.parse(this.selectedProforma.tableData);
              } catch (e) {
                console.error("Error parsing tableData:", e);
              }
            } else if (Array.isArray(this.selectedProforma.tableData)) {
              items = this.selectedProforma.tableData;
            }
          }
        }
        ...
        if (!items || items.length === 0) {
          if (this.selectedProforma.items) {
            if (typeof this.selectedProforma.items === "string") {
              try {
                items = JSON.parse(this.selectedProforma.items);
              } catch (e) {
                console.error("Error parsing items:", e);
              }
            } else if (Array.isArray(this.selectedProforma.items)) {
              items = this.selectedProforma.items;
            }
          }
        }
      ...
      subTotal() {
        if (!this.proformaItems || !this.proformaItems.length) return 0;
        return this.proformaItems.reduce((sum, item) => {
      ...
      totalAmount() {
        // Use total_cost from proforma data if available, otherwise calculate from items
        if (this.selectedProforma.total_cost) {
          return parseFloat(this.selectedProforma.total_cost);
        }
      ...
      summaryRowspan() {
        ...
        if (this.itemConfiguration.items_wise_discount && this.selectedProforma.discount_percent && parseFloat(this.selectedProforma.discount_percent) > 0) count++;
        if (this.selectedProforma.tax_type && this.selectedProforma.tax_type !== 'Exempt') count++;
        if (this.selectedProforma.round_off && parseFloat(this.selectedProforma.round_off_amount || '0') !== 0) count++;
        return count;
      },
    },
    ...
    methods: {
      getTotalColumns() {
        // Fixed columns matching QuotationPreviewDialog: Sl.No., Item#, Description, Unit price, Qty., GST@, Line total = 7
        return 7;
      },
      closeDialog() {
      ...
      async printProforma() {
        // Get the proforma content element
        const proformaElement = this.$refs.quotationContent;
        
        // Find the scrollable parent container (could be v-card-text or dialog content)
        let scrollableContainer = proformaElement;
        let parent = proformaElement.parentElement;
        ...
        const allImages = proformaElement.querySelectorAll("img");
        ...
        const vImgWrappers = proformaElement.querySelectorAll(".v-img");
        ...
        const clonedElement = proformaElement.cloneNode(true);
        ...
        printWindow.document.write(`
          <html>
            <head>
                      <title>Proforma - ${
          this.selectedProforma.invoice_no || "N/A"
        }</title>
              <style>
                * {
        ...
        try {
          ...
          pdf.save(`proforma-${this.selectedProforma.invoice_no || 'N/A'}.pdf`);
          */
        } catch (error) {
...
@media print {
  ...
  * {
  ...
  /* Customer section print styles - increased font sizes */
  .customer-section {
  ...
  .customer-section .customer-detail {
    ...
    /* Notes and Proforma Summary print styles */
    .notes-summary-container {
