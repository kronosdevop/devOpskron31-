          ...
          <v-col cols="12" sm="6" md="4">
            ...
            >
              <v-card-text class="text-center pa-1">
                ...
                <div class="text-body-1 font-weight-medium">Received</div>
              </v-card-text>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" sm="6" md="4">
            ...
            >
              <v-card-text class="text-center pa-1">
                ...
                <div class="text-body-1 font-weight-medium">Balance</div>
              </v-card-text>
            </v-card>
          </v-col>
          ...
          >
            <template v-slot:no-data>
              <div class="text-center py-8">
                ...
                >
                <div class="text-h6 text-grey mb-2">No Invoices Found</div>
            ...
            <template v-slot:loading>
              <div class="text-center py-8">
                <v-progress-circular
                  ...
                  class="mb-4"
                ></v-progress-circular>
                <div class="text-body-2 text-grey">Loading invoices...</div>
              </div>
            </template>
          ...
          <div class="table-footer">
            <div class="footer-info">
              {{
                totalItems === 0
                  ? "No Results"
                  : `Showing ${paginatedItems.length} of ${totalItems} invoices`
              }}
            </div>
...
import EditSaleDialog from "./InvoiceComponents/EditSaleDialog.vue";
import SaleInvoicePreviewDialog from "./SaleInvoicePreviewDialog.vue";
...
export default {
  ...
  async mounted() {
    ...
    try {
      ...
      // console.log("salesPurchaseConfig in SalesInvoice:", this.salesPurchaseConfig);
    } catch (error) {
    ...
    async loadInvoices() {
      ...
      try {
        ...
        if (result.Status === "SUCCESS") {
          ...
          // console.log("Overall Transactions:", result.overal_transactions);
