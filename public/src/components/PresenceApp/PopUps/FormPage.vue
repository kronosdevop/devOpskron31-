  ...
  <div>
    ...
    <v-card class="mt-4">
      <v-card-title class="config-header"
        ...
        Forms  <v-icon color="primary" @click="refresh_form">mdi-refresh</v-icon></v-card-title
      >
      <v-card-text>
        <v-data-table
          :headers="headers"
...
<v-menu>
  ...
  <v-list>
    <v-list-item @click="Preview(item)"> 
      <v-list-item-title>
        <v-icon>mdi-eye</v-icon> View Form
      </v-list-item-title>
    </v-list-item>
   <v-list-item @click="editForm(item)"> 
      <v-list-item-title>
        <v-icon color="blue">mdi-pencil</v-icon> Edit Form
      </v-list-item-title>
    </v-list-item>
