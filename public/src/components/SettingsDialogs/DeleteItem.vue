<template>
  <div>
    <!-- eslint-disable -->
    <v-dialog
      :model-value="itemdeletion"
      @update:model-value="$emit('update:itemdeletion', $event)"
      persistent
      max-width="400"
      ...
      <v-card>
        <v-toolbar elevation="0" dark density="compact" class="bg-white">
          <!-- <v-toolbar-title class="ml-2">
            <div class="custom-title">Delete Item</div></v-toolbar-title
          > -->
          <v-spacer />
