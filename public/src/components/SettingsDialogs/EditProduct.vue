<template>
  <div>
    <!-- eslint-disable -->
    <v-dialog :model-value="editProductDialogue" @update:model-value="$emit('update:editProductDialogue', $event)"
      persistent
      max-width="500"
      ...
      <v-card>
        <v-toolbar elevation="0" dark dense class="navBar">
          <v-toolbar-title class="text--black">
            <div class="custom-title">Edit Product/Services</div>
          </v-toolbar-title>
          <v-spacer />
...
export default {
  ...
  watch: {
    editProductDialogue: {
      async handler() {
        if (this.editProductDialogue == true) {
          this.upload_file = false;
          this.productName = this.rowInfo.product_name;
          this.imgSrc = this.rowInfo.product_logo_url;
          this.productDescription = this.rowInfo.product_description;
          this.productUrl = this.rowInfo.product_link;
        }
      },
      immediate: true,
    },
