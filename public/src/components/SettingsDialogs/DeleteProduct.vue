<template>
  <div>
    <!-- eslint-disable -->
    <v-dialog :model-value="deleteProductDialogue" @update:model-value="$emit('update:deleteProductDialogue', $event)" persistent max-width="400" transition="dialog-top-transition">
      <v-card>
