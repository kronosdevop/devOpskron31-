      ...
      <v-col cols="12" md="12">
        <v-card flat class="pa-4 overflow-y-auto">
          ...
          <div class="d-flex align-center justify-space-between mb-4">
            ...
            <v-btn size="x-small" class="action-btn ml-2" @click="addProduct">
            ...
            <v-table class="products-table">
              <thead>
                <tr>
                  ...
                  <th class="text-left font-weight-bold">QUANTITY</th>
                                    <th class="text-left font-weight-bold">SALE PRICE</th>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <span
                      :style="{ color: getStockColor(product.sale_price.sale_price) }"
                    >
                      {{
...
import ViewProductsDetails from "./ViewProductsDetails.vue";
