<template>
  ...
  <div>
    <v-dialog
      :model-value="deleteServiceDialog"
      @update:model-value="$emit('update:deleteServiceDialog', $event)"
      persistent
      max-width="400"
      ...
      <v-card>
        ...
        <v-card-text class="mt-4">
          <div class="text-center">
            ...
            <strong>{{ serviceItem.item_name }} Service</strong> ?
          </div>
        </v-card-text>
        ...
        const result = await API.graphql(
          graphqlOperation(edit_items, {
            input: {
              ...
              item_id: this.serviceItem.item_id,
            },
          })
        );
