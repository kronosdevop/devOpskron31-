  ...
  <div>
    ...
    <v-card class="" flat >
      <!-- <v-card-title class="d-flex align-center">
          ...
          Petty Cash Request Approval Configuration
        </v-card-title> -->
      <v-card-text>
        <v-row no-gutters>
          <!-- <v-col cols="4">
              <v-card-text class="mt-n4" v-if="queryCheck == true">
                <PettyCashRequestFormView :templateSteps="templateSteps" />
              </v-card-text>
            </v-col> -->
          <v-col cols="8">
              ...
              <v-stepper-content step="2">
                <v-card class="mt-n4" v-if="step === 2" flat>
                  <FormConfiguration
                    ...
                    :tableData="tableData"
                    :templete="templete"
                    :workflowType="'petty_cash_request'"
        ...
        <v-toolbar elevation="0" dark density="compact" class="navBar">
          <v-toolbar-title class="ml-2">
            <div class="custom-title">
              Configure Petty Cash Request Steps
            </div></v-toolbar-title
          >
          <v-spacer />
          ...
          <v-form ref="form">
            <v-row no-gutters class="mt-4">
              <v-col cols="6">
                <v-radio-group
                  @update:modelValue="
                    fetch_selected_data(pettyCashRequestHead, 'initator')
                  "
                  v-model="initiator"
                  row
                  color="primary"
            ...
            <v-row no-gutters>
              <v-col cols="6">
                <v-radio-group
                  @change="
                    fetch_selected_data(
                      pettyCashRequestHead,
                      'pettycashrequest'
                    )
                  "
                  v-model="pettyCashRequestHead"
                  row
                  color="primary"
                >
                  <v-radio
                    label="Group Head"
                    value="pettyCashRequestHeadNew"
                  ></v-radio>
                </v-radio-group>
              </v-col>
            </v-row>
    ...
    async get_initiated_petty_cash_request() {
      ...
      try {
        ...
        if (response.Status == "SUCCESS") {
          ...
          const pettyCashAdvanceWorkflow = response.data.find(
            (workflow) => workflow.form_unique_type === "PETTY_CASH_ADVANCE"
          );
