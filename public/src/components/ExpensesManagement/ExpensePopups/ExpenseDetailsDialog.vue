      ...
      <v-card class="">
        <v-toolbar elevation="0" dark dense class="navBar">
          <v-toolbar-title class="text--black ml-2">
            <div class="custom-title">Expense Details</div>
          </v-toolbar-title>
          <v-spacer />
                ...
                <v-row>
                  ...
                  >
                    ...
                    <div
                      ...
                      "
                    >
                      <b v-if="n.data_type == 'epoch'"
                        >: {{ fetch_time(n.respectiveValue * 1000) }}</b
                      >
                      <b v-else>
                        : <span v-html="formatText(n.respectiveValue)"></span
                      ></b>
                    </div>
                  </v-col>
                </v-row>
    ...
    async fetch_expense_data() {
      ...
      array = [
        ...
        },
        {
          ...
          is_displayed: true,
          is_readonly: false,
          value_label: "sub_category_text",
          input_array_value: null,
          display_weightage: 300,
          is_required: false,
          data_type: "string",
          value: null,
          key: "sub_category_text",
        },
        {
          is_editable: true,
          section: null,
          input_value: "vendor_name",
          display_label: "Vendor",
          is_displayed: true,
          is_readonly: false,
          value_label: "vendor_name",
          input_array_value: null,
          display_weightage: 200,
          is_required: true,
          data_type: "single_choice",
      ...
      const expenseDataMap = {
        user_id:
          this.expenseData.user_name || this.expenseData.user_email_id || "N/A",
        category_id: this.expenseData.category_id_text || "N/A",
        sub_category_text: this.expenseData.sub_category_text || "N/A",
        vendor_name: this.expenseData.vendor_name || "N/A",

        bill_date: this.expenseData.bill_date || "N/A",
        bill_no: this.expenseData.bill_no || "N/A",
        amount: this.expenseData.amount || "N/A",
        expense_description:
          this.expenseData.expense_description ||
        ...
        transaction_created_on: this.expenseData.transaction_created_on
          ? this.expenseData.transaction_created_on
          : "N/A",
      };
