    ...
    <v-card>
      <v-toolbar elevation="0" dark dense class="navBar">
        <v-toolbar-title class="text--black ml-2">
          ...
          custom_details.dashboard_type == "CUSTOM"
      ...
      <!-- <div
        v-if="
          custom_details.dashboard_type == 'CUSTOM' &&
          custom_details.dashboard_created_by !=
      ...
      <div v-else-if="custom_details.dashboard_type == 'CUSTOM'"> -->
        ...
        <v-card-text class="mt-4">
          <div class="text-left">
            ...
            <b> {{ custom_details.dashboard_name }}</b> ?
          </div>
        </v-card-text>
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(edit_or_delete_dashboard_topic, {
            input: {
              action_type: "DELETE",
              dashboard_id: this.custom_details.dashboard_id,
        ...
        if (response.Status == "SUCCESS") {
          ...
          this.$emit("deleteMSg", "deleted Dashboard");
