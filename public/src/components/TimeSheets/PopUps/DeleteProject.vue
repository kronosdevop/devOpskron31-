<template>
  <div>
    ...
    <script>
/* eslint-disable */
import { delete_projects } from "@/graphql/mutations.js";
    ...
    async delete_mutation() {
      ...
      try {
        let result = await API.graphql(
          graphqlOperation(delete_projects, {
            input: {
        ...
        var response = JSON.parse(result.data.delete_projects);
        this.loading = false;
