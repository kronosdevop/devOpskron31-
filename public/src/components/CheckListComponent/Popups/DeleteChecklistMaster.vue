<template>
  <!-- eslint-disable -->
  <v-dialog
    :model-value="deleteChecklistDialog"
    @update:model-value="$emit('update:deleteChecklistDialog', $event)"
    persistent
    max-width="400"
    ...
    <v-card>
      ...
      <v-card-text class="mt-4">
        <div class="text-center">
          ...
          <strong>{{ ChecklistItem.checklist_name }}</strong> ?
        </div>
      </v-card-text>
